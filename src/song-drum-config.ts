	...
	mimizuki: {
		...
		pattern: [
			...
			},
			{
				...
				pattern: [{ step: 0, pitch: DRUM_KEYS.crash, velocity: 0.8 }],
			},
			{
				ranges: [
					[32, 32],
	...
	budou_ga_kage_kara_nozoiterunda: {
		...
		pattern: [
			...
			},
			{
				...
				pattern: [{ step: 24, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 }],
			},
			{
				ranges: [
					[13, 47],
				...
				pattern: [
					{ step: 72, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 120, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 168, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
				],
			},
			{
				ranges: [[37, 92]],
			...
			},
			{
				ranges: [[29, 36]],
				pattern: [
					{ step: 48, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 72, pitch: DRUM_KEYS.bassDrum1, velocity: 0.8 },
					{ step: 96, pitch: DRUM_KEYS.handClap, velocity: 0.8 },
					{ step: 144, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
			...
			},
			{
				...
				pattern: [
					{ step: 0, pitch: 67, velocity: 0.5 },
					{ step: 0, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					...
					{ step: 60, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 72, pitch: 53, velocity: 0.8 },
					{ step: 72, pitch: DRUM_KEYS.acousticSnare, velocity: 0.8 },
					{ step: 96, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 120, pitch: 60, velocity: 0.8 },
					{ step: 120, pitch: 68, velocity: 0.5 },
					{ step: 144, pitch: 60, velocity: 0.8 },
				],
			...
			},
			{
				ranges: [[29, 29]],
				pattern: [
					{ step: 0, pitch: DRUM_KEYS.crash, velocity: 0.8 },
					{ step: 32, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 40, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 128, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 136, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
				],
			},
			{
				ranges: [
				...
				pattern: [
					{ step: 0, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 8, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 16, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 24, pitch: DRUM_KEYS.bassDrum1, velocity: 0.8 },
					{ step: 84, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 96, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 120, pitch: DRUM_KEYS.bassDrum1, velocity: 0.8 },
					{ step: 132, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 156, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
					{ step: 180, pitch: DRUM_KEYS.hihatPedal, velocity: 0.8 },
				],
			},
			{
				ranges: [
