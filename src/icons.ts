...
const ICONS: Record<string, IconDef> = {
	...
	/** ヘルプ（？マークの丸）。info と違い「使い方の入口」を表す。 */
	help: {
		d: "M12 2a10 10 0 100 20 10 10 0 000-20zm.07 15.5a1.2 1.2 0 110-2.4 1.2 1.2 0 010 2.4zM13 13.4v.6h-2v-1.2c0-.6.3-1 .8-1.4l.9-.7c.4-.3.6-.6.6-1 0-.7-.5-1.2-1.3-1.2s-1.3.5-1.3 1.3H8.7c0-1.8 1.4-3.1 3.3-3.1s3.3 1.2 3.3 2.9c0 .9-.4 1.5-1.2 2.1l-.7.5c-.3.3-.4.5-.4.8z",
	},
	more: {
